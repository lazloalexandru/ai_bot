...
class Net(nn.Module):
    def __init__(self, output_classes):
        ...
        f_prev = f
        f = f * 2
        self.conv9 = nn.Conv2d(f_prev, f, kernel_size=(1, k), stride=1)
        self.bn9 = nn.BatchNorm2d(f)
        self.conv10 = nn.Conv2d(f, f, kernel_size=(1, k), stride=1)
        self.bn10 = nn.BatchNorm2d(f)

        linear_input_size = f * 12
        d = 2048
